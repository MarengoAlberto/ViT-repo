...
model_kwargs = {
            "embed_dim": os.environ.get("EMBED_DIM", 256),
            "hidden_dim": os.environ.get("HIDDEN_DIM", 512),
            "num_heads": os.environ.get("NUM_HEADS", 8),
            "num_layers": os.environ.get("NUM_LAYERS", 6),
            "patch_size": os.environ.get("PATCH_SIZE", 4),
            "num_channels": os.environ.get("NUM_CHANNELS", 3),
            "num_patches": os.environ.get("NUM_PATCHES", 64),
            "num_classes": os.environ.get("NUM_CLASSES", 10),
            "dropout": os.environ.get("DROPOUT", 0.2)
        }
...
trainer_kwargs = {
            ...
            "max_epochs": os.environ.get("MAX_EPOCHS", 180),
            "callbacks": [
